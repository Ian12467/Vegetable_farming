...
class Kunde_Tips : Fragment(R.layout.fragment_kunde__tips)
{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerview = view.findViewById(R.id.kunde_Tips_Recyclerview)
    ...
    fun getAboutData() {
        ...
        dbref.collection("kunde_Tips").addSnapshotListener { value, error ->
            if (error != null) {
